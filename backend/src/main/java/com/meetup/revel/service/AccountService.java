...
import com.meetup.revel.exception.runtime.BadTokenException;
import com.meetup.revel.exception.runtime.DatabaseWorkException;
import com.meetup.revel.exception.runtime.HashAlgorithmException;
import com.meetup.revel.exception.runtime.NoTokenException;
import com.meetup.revel.exception.runtime.frontend.detailed.EmailAlreadyUsedException;
import com.meetup.revel.exception.runtime.frontend.detailed.EmailNotFoundException;
import com.meetup.revel.exception.runtime.frontend.detailed.FailedToLoginException;
import com.meetup.revel.exception.runtime.frontend.detailed.LoginAlreadyUsedException;
import com.meetup.revel.security.AuthenticationFacade;
import com.meetup.revel.security.utils.HashMD5;
import com.meetup.revel.service.vm.LoginVM;
import com.meetup.revel.service.vm.RecoveryPasswordVM;
import com.meetup.revel.service.vm.UserAndTokenVM;
